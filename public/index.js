...
function showWelcomePopup() {
  ...
  popupTitle.textContent = 'Welcome to Sazumi Cloud CDN';

  const popupMessage = document.createElement('p');
  popupMessage.innerHTML = 'With Sazumi Cloud CDN, we deliver the best speed, security, and performance for your website. Enjoy faster, safer, and more reliable content wherever your visitors are.<br><br>Explore our features and if you have any questions, our support team is ready to help you anytime.<br><br>Thank you for choosing Sazumi Cloud CDN!';
